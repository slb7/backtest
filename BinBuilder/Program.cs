        ...
        static void Main(string[] args)
        {
            ...
            if(buildArgs == 1)
            {
                ...
                foreach (var g in groups)
                {
                    ...
                    string[] symbols = g.ToArray();
                    symbols = (from sym in symbols select sym.Split(',')[0]).ToArray();
                    Array.Sort(symbols);
