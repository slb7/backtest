...
namespace Backtest.Infrastructure
{
    public abstract class Test
    {
        ...
        public string[] run(IBarDay[] barDays, string[] symbols, string[] dates)
        {
            Container.testDictionary.Clear();
            List<Tuple<string, DateTime>> screened = Container.ScreenAll(symbols, dates, this);
